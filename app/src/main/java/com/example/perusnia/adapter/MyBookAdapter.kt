...
import kotlinx.android.synthetic.main.mybook_item.view.*
import java.text.NumberFormat
import java.util.*
import kotlin.collections.ArrayList

class MyBookAdapter(val data: ArrayList<DataX>, val listener: OnAdapterListener): RecyclerView.Adapter<MyBookAdapter.ViewHolder>(){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = ViewHolder (
        LayoutInflater.from(parent.context).inflate(R.layout.mybook_item,parent,false)
    )
